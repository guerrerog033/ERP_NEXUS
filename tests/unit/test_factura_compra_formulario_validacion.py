...
_LV = FormularioFacturaCompra._linea_vacia
_VALIDAR = FormularioFacturaCompra._validar_documento_basico
...
class TestLineasNoVacias:
    ...
    def test_filtra_las_vacias(self):
        ...
        resultado = FormularioFacturaCompra._lineas_no_vacias(form, lineas)
