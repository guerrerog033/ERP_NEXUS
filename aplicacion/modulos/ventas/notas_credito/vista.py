...
class VistaNotaCreditoVenta(VistaDocumento):
    ...
    def __init__(
        ...
        self.datasource = NotaCreditoVentaDataSource()
    ...
    def _confirmar_generacion(
        ...
        confirmar = QMessageBox.question(
            ...
            "(saldo, inventario y contabilidad "
            "según configuración) sin enviar a la DIAN. "
            "¿Desea continuar?",
            QMessageBox.StandardButton.Yes
            | QMessageBox.StandardButton.No,
        )
    ...
    def _imprimir(
        ...
        from aplicacion.modulos.ventas.notas_credito.impresion import (
            imprimir_nota_credito_venta,
        )
    ...
    def _exportar_pdf(
        ...
        from aplicacion.modulos.ventas.notas_credito.impresion import (
            exportar_pdf_nota_credito_venta,
        )
