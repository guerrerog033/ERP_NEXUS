...
class ServicioNotaCreditoVenta(ServicioBase):

    repositorio = RepositorioNotaCreditoVenta

    entidad_auditoria = "NotaCreditoVenta"

    modulo_auditoria = "ventas/notas_credito"
    ...
    def validar_cabecera(
        ...
        if cls.repositorio.existe_numero(
            ...
            raise ValueError(
                "Ya existe una nota crédito con ese número.",
            )
        ...
        if not cabecera.get(
            ...
            raise ValueError(
                "La nota crédito debe referenciar "
                "una factura.",
            )
