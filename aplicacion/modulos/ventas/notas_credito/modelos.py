...
class NotaCreditoVenta(Base):
    ...
    __tablename__ = "notas_credito_venta"
    ...
    detalles = relationship(
        ...
        order_by="NotaCreditoVentaDetalle.orden",
    )


class NotaCreditoVentaDetalle(Base):

    __tablename__ = "nota_credito_venta_detalles"
    ...
    nota_credito_id = Column(
        Integer,
        ForeignKey("notas_credito_venta.id"),
        nullable=False,
    )
