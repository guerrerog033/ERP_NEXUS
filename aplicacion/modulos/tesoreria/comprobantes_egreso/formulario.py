...
from aplicacion.modulos.tesoreria.comprobantes_egreso.comprobante_definition import (
    ComprobanteEgresoDefinition,
)
...
class FormularioComprobanteEgreso(Page):

    titulo = "Comprobante de egreso"

    definition = ComprobanteEgresoDefinition
    ...
    def _crear_ui(self):
        ...
        self.lbl_total = QLabel("Total egreso: $ 0")
    ...
    def _cargar_registro(self):
        ...
        valores = {
            detalle.factura_compra_id: detalle.valor_aplicado
    ...
    def _guardar(self):
        ...
        try:
            ...
            comprobante = self.datasource.guardar_completo(
                cabecera,
                lineas,
                id_registro=self.id_registro,
            )

            IntegracionComprobanteEgreso.contabilizar_automatico(
                comprobante.id,
            )
